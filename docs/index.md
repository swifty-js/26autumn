...
hero:
  ...
  tagline: 技术知识整理、实习与工作期间的技术笔记、项目源码解析
  actions:
    - theme: brand
      text: 前端基础
      link: /fe/react
...
features:
  - title: 前端基础
    ...
    link: /fe/react
  - title: Swifty 前端
    details: Swifty 前端框架相关的深度技术笔记, 包括 CLI、Agent、Chatbot、Sentry 等模块
    link: /fe/swifty
  - title: 后端基础
    details: Go 语言、分布式系统、数据库及中间件相关知识
    link: /be/go
  - title: Swifty 后端
    details: Swifty 后端框架相关的深度技术笔记, 包括 Swiftx、HTTP、RPC、Cache 等模块
    link: /be/swiftx
  - title: 工作笔记
