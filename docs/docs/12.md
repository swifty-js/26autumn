...
> 本机器路径 /Users/hangtiancheng/github/26autumn/packages/swr-demo
...
| performance.mark onebp-boot-start/end | swr-boot-start/end               | main.tsx 入口打起点, 每轮 run 会 resetBootMarks 后在 run 内重打, measure 实际以 run 内的起点为准; SWR 数据就绪打终点 |
...
| AESPluginPerf.markWithEntry           | report 函数                      | 统一事件格式 p1/c1-c5/p4                                                                                             |
